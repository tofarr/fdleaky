...
class TestFdInfoFactory:
    ...
    def setup_method(self):
        ...
        self.factory = FdInfoFactory(min_age=60, identifier_include_any_of=["test", "example"])
    ...
    def test_create_fd_info_with_old_fd(self):
        ...
        assert result.identifier == "File \"/usr/lib/python3.9/test_module.py\", line 45, in test_function"
    ...
    def test_get_identifier_with_match(self):
        ...
        # Assert
        assert result == "File \"/usr/lib/python3.9/test_module.py\", line 45, in test_function"

    def test_get_identifier_with_multiple_matches(self):
        """Test getting an identifier with multiple matching stack frames."""
        # Arrange
        factory = FdInfoFactory(min_age=60, identifier_include_any_of=["test", "example"])
